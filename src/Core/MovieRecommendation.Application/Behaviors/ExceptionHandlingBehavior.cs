...
namespace MovieRecommendation.Application.Behaviors
{
    public class ExceptionHandlingBehavior<TRequest, TResponse, TException> : IRequestExceptionHandler<TRequest, TResponse?,
          TException>
